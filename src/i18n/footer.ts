...
export const en: Dict = {
  ...
  'footer.products.replichai': 'ReplicHAI',
  'footer.products.platform': 'Latere Platform',
  ...
  'footer.latere': 'Latere',
  'footer.about': 'About',
  'footer.whyLatere': 'Why Latere',
...
export const zh: Dict = {
  ...
  'footer.platform': '平台',
  'footer.products.replichai': 'ReplicHAI',
  'footer.products.platform': 'Latere 平台',
  'footer.products.wallfacer': 'Wallfacer',
  'footer.products.topos': 'Topos',
  'footer.products.cella': 'Cella',
  'footer.products.lux': 'Lux',
