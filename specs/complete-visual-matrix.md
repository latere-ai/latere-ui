...
The strict local run passed all 827 browser tests; native macOS 15 recording passed the same 827 tests in [run 34723912848](https://github.com/latere-ai/latere-ui/actions/runs/34723912848). Type checking and 540 unit tests pass with 94.37% source line coverage. Main CI compares against the reviewed native references. [Review findings](../docs/complete-visual-review.md), the [visual index](../docs/visual-reference.md), README examples and integration guides document the resulting behavior and reproducible checks. No pixel tolerance, masks or automatic baseline approval were introduced.
