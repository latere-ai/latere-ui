...
- Translate new labels into English, German, and Chinese. Make footer hover feedback a background highlight without added underlines.
- Give the full footer a brand/preferences row followed by six navigation columns, reducing to two columns on narrow screens. Compact groups wrap as complete groups where space permits. Preserve each preset's typography, colors, and control geometry.
