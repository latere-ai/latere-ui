...
![Light material tiers, panels, toolbar, and table](../tests/visual/goldens/darwin/vue-containers-light-desktop.png)

![Dark material tiers, panels, toolbar, and table](../tests/visual/goldens/darwin/vue-containers-dark-desktop.png)
...
![Vue button variants with size, disabled, and loading examples](../tests/visual/goldens/darwin/vue-buttons-light-desktop.png)

![React fields and choice controls in the dark theme](../tests/visual/goldens/darwin/react-forms-dark-desktop.png)
...
![Console sidebar with grouped navigation, counters, and live state](../tests/visual/goldens/darwin/vue-sidebar-light-desktop.png)
...
![Documentation index, article, and table of contents](../tests/visual/goldens/darwin/vue-docs-light-desktop.png)
...
![Compact footer on a narrow viewport](../tests/visual/goldens/darwin/vue-footer-compact-light-mobile.png)
...
![Glass refraction and sheen fixture in the light theme](../tests/visual/goldens/darwin/vue-effects-light-desktop.png)
